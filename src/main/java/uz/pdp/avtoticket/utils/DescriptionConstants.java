...
public interface DescriptionConstants {
    ...
    String DESCRIPTION_PASSENGER = """
            A traveler who uses the app mainly for trips. Can book and cancel tickets, view their travel history, and
             receive notifications about trips.""";
    String DESCRIPTION_DRIVER = """
            A vehicle driver. Responsibilities include managing assigned trips, updating trip status, viewing the list
             of passengers for assigned trips, and monitoring vehicle status.""";
